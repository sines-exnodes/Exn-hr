    ...
    <Card>
      <div className="flex items-start justify-between">
        <div>
          ...
          {change && (
            <p
              className={`mt-1 text-xs font-medium ${positive ? "text-green-600" : "text-red-500"}`}
            >
              {change}
            </p>
          )}
...
export default function DashboardPage() {
  ...
  return (
    <>
      <Header title="Dashboard" breadcrumbs={[{ label: "Tổng quan" }]} />
            ...
            <Card padding="none">
              <div className="p-5 border-b border-slate-100">
                <CardHeader>
                  ...
                  <a
                    href="/attendance"
                    className="text-sm font-medium text-[#22C55E] hover:text-green-700"
                  >
                    Xem tất cả →
                  </a>
                </CardHeader>
          ...
          <div className="space-y-4">
            ...
            <Card>
              ...
              <div className="space-y-2">
                {leaveLoading ? (
                  ...
                  pendingLeaveList.map((req) => {
                    ...
                    return (
                      <div
                        key={req.id}
                        className="flex items-start gap-3 rounded-lg p-2 hover:bg-slate-50 transition-colors"
                      >
                ...
                <a
                  href="/leave"
                  className="block pt-1 text-center text-xs font-medium text-[#22C55E] hover:text-green-700"
                >
                  Xem tất cả →
                </a>
              </div>
