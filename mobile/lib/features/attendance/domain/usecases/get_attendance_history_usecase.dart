...
class GetAttendanceHistoryUseCase {
  ...
  Future<Either<ApiError, List<AttendanceRecord>>> call({int page = 1, int size = 20, String? startDate, String? endDate}) {
    return _repository.getHistory(page: page, size: size, startDate: startDate, endDate: endDate);
  }
}
